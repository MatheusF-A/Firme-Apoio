document.addEventListener('DOMContentLoaded', () => {
    ...
    const modalOverlay = document.getElementById('modal-novo-exercicio'); // ATUALIZADO
    const modalTitle = document.getElementById('modal-title');
    const form = document.getElementById('form-exercicio-modal'); // ATUALIZADO
    const hiddenExercicioID = document.getElementById('modal-exercicioID'); // ATUALIZADO
    
    const abrirBtn = document.getElementById('btn-abrir-modal-exercicio'); // ATUALIZADO
    ...
    function resetForm() {
        ...
        hiddenExercicioID.value = ''; // Limpa o ID oculto // ATUALIZADO
    }
    ...
    if (abrirBtn) {
        abrirBtn.addEventListener('click', () => {
            resetForm();
            modalTitle.textContent = 'NOVO EXERCÍCIO'; // ATUALIZADO
            form.action = '../controles/cadastrar-exerciciobd.php'; // Ação de Cadastrar // ATUALIZADO
    ...
    btnsEditar.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            resetForm();
            modalTitle.textContent = 'EDITAR EXERCÍCIO'; // ATUALIZADO
            form.action = '../controles/editar-exerciciobd.php'; // Ação de Editar // ATUALIZADO
            ...
            hiddenExercicioID.value = id; // Define o ID oculto // ATUALIZADO
