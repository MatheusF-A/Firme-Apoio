...
// --- 4. Inserção no Banco de Dados (Tabela habitos) ---
try {
    // Usando as colunas da tabela habitos (Quadro 16) + as que adicionamos
    $sql = "INSERT INTO habitos (usuarioID, nome, detalhes, frequenciaID, imagem, concluido) 
    ...
    send_json_response('success', 'Novo hábito cadastrado com sucesso!');
    ...
    send_json_response('error', 'Erro ao salvar o hábito: ' . $e->getMessage());
}
?>