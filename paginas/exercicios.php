...
$frequencias = [];
try {
    // 1. Buscar os exercicios
    $sqlExercicios = "SELECT exercicioID, nome, detalhes, imagem, concluido, frequenciaID
                      FROM exercicios 
                      WHERE usuarioID = :usuarioID 
                      ORDER BY concluido ASC, exercicioID DESC";
    ...
    <main class="main-content">
        ...
        <div class="exercicio-container">
            ...
            <section class="exercicio-list">
                <?php if (isset($erro)): ?>
                    <p><?php echo $erro; ?></p>
                <?php elseif (empty($exercicios)): ?>
                    <p class="exercicio-vazio">Você ainda não cadastrou nenhum exercício. Comece clicando em "Novo Exercício"!</p>
                <?php else: ?>
